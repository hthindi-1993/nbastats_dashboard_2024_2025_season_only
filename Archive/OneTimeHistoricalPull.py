...
def get_player_game_logs(season_start_year):
    ...
    df=playergamelogs.PlayerGameLogs(season_type_nullable='Regular Season',season_nullable=f'{season_begin}-{season_end}',date_to_nullable='3/21/2025').get_data_frames()[0][[
...
def get_player_game_logs_advanced(season_start_year):
    season_begin = str(season_start_year)
    season_end = str(season_start_year+1)[2:]
    df=playergamelogs.PlayerGameLogs(season_type_nullable='Regular Season',season_nullable=f'{season_begin}-{season_end}',date_to_nullable='3/21/2025',
